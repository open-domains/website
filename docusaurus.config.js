...
const config = {
  title: 'Open Domains',
  tagline: 'Subdomains for everyone',
  ...
  organizationName: 'open-domains', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Discord',
                href: 'https://discord.gg/kVjkg6VBwa',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} OPEN-DOMAINS`,
      },
      prism: {
